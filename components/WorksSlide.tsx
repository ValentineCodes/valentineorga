                    ...
                    <div key={_.toString()}>
                        <div className='flex flex-col max-md:space-y-10 md:flex-row md:space-x-10 items-center'>
                            ...
                            <div className='flex flex-col items-center'>
                                <div className="bg-[url('/images/coding_bg0.jpeg')] bg-no-repeat bg-cover w-[180px] aspect-[3/4] border-8 border-[#4d4d4d]">
                            ...
                            <div className='flex flex-col items-center'>
                                ...
                                <div className="bg-[url('/images/profile_image.webp')] bg-no-repeat bg-cover w-[230px] aspect-[16/10] border-8 border-[#4d4d4d]">
