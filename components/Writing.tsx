...
export default function Writing() {
  return (
    <section id="writing" className="border-b border-border bg-bg py-20 md:py-28">
      <div className="container">
        ...
        <Reveal delay={0.1}>
          <div className="rounded-lg border border-dashed border-border p-8 text-sm text-muted">
            Nothing published yet — notes on smart contract patterns, Web3 tooling, and shipping
            decisions will land here.{" "}
